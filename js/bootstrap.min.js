/*!
 * TELEPREMB v4.2.1 (https://getTELEPREMB.com/)
 * Copyright 2011-2018 The TELEPREMB Authors (https://github.com/twbs/TELEPREMB/graphs/contributors)
 * Licensed under MIT (https://github.com/twbs/TELEPREMB/blob/master/LICENSE)
 */
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e((t.TELEPREMB = {}), t.Popper, t.jQuery);
})(this, function (t, u, g) {
  "use strict";
  function i(t, e) {
              ...
              if ((g(t).trigger(i), !i.isDefaultPrevented())) {
                if (!this._inNavbar) {
                  if ("undefined" == typeof u)
                    throw new TypeError(
                      "TELEPREMB's dropdowns require Popper.js (https://popper.js.org/)"
                    );
                  var o = this._element;
  ...
  var pe = "tooltip",
    ...
    Ue = (function () {
      function i(t, e) {
        if ("undefined" == typeof u)
          throw new TypeError(
            "TELEPREMB's tooltips require Popper.js (https://popper.js.org/)"
          );
        (this._isEnabled = !0),
          (this._timeout = 0),
          (this._hoverState = ""),
  ...
  (g.fn[Rn] = Xn._jQueryInterface),
    ...
    (function () {
      if ("undefined" == typeof g)
        throw new TypeError(
          "TELEPREMB's JavaScript requires jQuery. jQuery must be included before TELEPREMB's JavaScript."
        );
      ...
      if (
        ...
        throw new Error(
          "TELEPREMB's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0"
        );
    })(),
    (t.Util = _),
    (t.Alert = p),
...
//# sourceMappingURL=TELEPREMB.min.js.map
